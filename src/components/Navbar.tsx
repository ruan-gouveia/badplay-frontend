...
import { precarregarCatalogoCache } from "@/services/catalogoCache";
    ...
    >
      <div className="flex items-center justify-between px-6 py-4 md:px-12">
        <div className="flex items-center gap-8">
          <Link href="/catalogo">
            <h1 className="text-2xl md:text-3xl font-bold text-red-600 tracking-wider cursor-pointer drop-shadow-md">
              BADPLAY
            </h1>
          </Link>
